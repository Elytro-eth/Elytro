...
export default function AccountOption({
  ...
  return (
    <div
      className={cn(
        'flex items-center gap-x-xl justify-between px-lg py-md rounded-sm cursor-pointer hover:bg-gray-50',
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="gap-y-lg max-w-md mx-auto" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="grid grid-cols-2 gap-x-sm">
            <Button variant="secondary" className="w-full" onClick={() => setIsOpen(false)} size="small">
              Cancel
            </Button>
