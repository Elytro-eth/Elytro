...
const ErrorTip = ({ title = 'Oops! Something went wrong', className }: IErrorTipProps) => (
  <div className={cn('w-full flex flex-1 flex-col items-center justify-center gap-y-sm py-2xl', className)}>
